...
def runmodel(epoch):
    ...
    for index in range(1,20):
        ...
        f = open('./finetune_ourdata_idxes_{}_{}.txt'.format(epoch,num_pca_components), 'w')
        idxes = []
        ...
        writer = pd.ExcelWriter('./finetune_ourdata_train_{}_{}.xlsx'.format(epoch,num_pca_components))
