...
class EnzymeCommissionOurVal(data.ProteinDataset):
    ...
    def __init__(self, path, test_cutoff=0.95, verbose=1, **kwargs):
        ...
        for split in ["train","test","valid"]:
            ...
            self.pdb_files += sorted(glob.glob(os.path.join(path, split, "*.pdb")))
        ...
        self.num_samples = [splits.count("train"), splits.count("test"), splits.count("valid")]
